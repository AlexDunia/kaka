<template>
  <div class="manage-view active" id="mv-settings">
    <div class="mv-wrap">
      <div class="mv-header">
        ...
        <div class="mv-p">Choose how people find your event, which updates you receive, and how your event is managed.</div>
      </div>
      <div class="card">
      ...
      <div class="danger-zone">
        <div class="danger-head"><div class="danger-head-title">Important actions</div><div class="danger-head-desc">These changes affect your whole event, so take a moment before continuing.</div></div>
